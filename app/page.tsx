...
const PARTICLES = [
  { left: '2%',  size: 2, duration: 6,   delay: 0,   dx: '8px'  },
  { left: '5%',  size: 3, duration: 7.5, delay: 2,   dx: '-6px' },
  { left: '8%',  size: 2, duration: 9,   delay: 0.5, dx: '10px' },
  { left: '12%', size: 4, duration: 8,   delay: 1.5, dx: '-8px' },
  { left: '16%', size: 2, duration: 6.5, delay: 3,   dx: '6px'  },
  { left: '20%', size: 3, duration: 7,   delay: 0.8, dx: '-12px'},
  { left: '24%', size: 5, duration: 9.5, delay: 1,   dx: '8px'  },
  { left: '28%', size: 2, duration: 8.5, delay: 2.5, dx: '-5px' },
  { left: '32%', size: 3, duration: 6,   delay: 0.3, dx: '14px' },
  { left: '36%', size: 2, duration: 7.5, delay: 3.8, dx: '-9px' },
  { left: '40%', size: 4, duration: 8,   delay: 1.2, dx: '7px'  },
  { left: '44%', size: 2, duration: 6.5, delay: 2.2, dx: '-11px'},
  { left: '48%', size: 3, duration: 9,   delay: 0.6, dx: '9px'  },
  { left: '52%', size: 2, duration: 7,   delay: 3.2, dx: '-6px' },
  { left: '56%', size: 5, duration: 8.5, delay: 1.7, dx: '12px' },
  { left: '60%', size: 2, duration: 6,   delay: 0.4, dx: '-8px' },
  { left: '64%', size: 3, duration: 7.5, delay: 2.8, dx: '6px'  },
  { left: '68%', size: 2, duration: 9,   delay: 1,   dx: '-10px'},
  { left: '72%', size: 4, duration: 8,   delay: 0.2, dx: '8px'  },
  { left: '75%', size: 2, duration: 6.5, delay: 3.5, dx: '-7px' },
  { left: '78%', size: 3, duration: 7,   delay: 1.4, dx: '11px' },
  { left: '82%', size: 2, duration: 8.5, delay: 2,   dx: '-9px' },
  { left: '85%', size: 4, duration: 6,   delay: 0.9, dx: '6px'  },
  { left: '88%', size: 2, duration: 9.5, delay: 3,   dx: '-13px'},
  { left: '91%', size: 3, duration: 7.5, delay: 1.6, dx: '8px'  },
  { left: '94%', size: 2, duration: 8,   delay: 0.1, dx: '-6px' },
  { left: '97%', size: 3, duration: 6.5, delay: 2.4, dx: '10px' },
  { left: '10%', size: 2, duration: 7,   delay: 4,   dx: '-8px' },
  { left: '22%', size: 3, duration: 8,   delay: 4.5, dx: '7px'  },
  { left: '34%', size: 2, duration: 6,   delay: 4.2, dx: '-10px'},
  { left: '46%', size: 4, duration: 9,   delay: 4.8, dx: '9px'  },
  { left: '58%', size: 2, duration: 7.5, delay: 5,   dx: '-6px' },
  { left: '70%', size: 3, duration: 8.5, delay: 4.3, dx: '12px' },
  { left: '83%', size: 2, duration: 6.5, delay: 5.2, dx: '-7px' },
  { left: '93%', size: 3, duration: 7,   delay: 4.7, dx: '8px'  },
]
